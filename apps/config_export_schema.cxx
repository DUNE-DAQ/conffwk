...
// Renamed since fork: yes (from bin/config_export_schema.cpp to apps/config_export_schema.cxx).
//
...
main(int argc, char* argv[])
{
  ...
  try {
    desc.add_options()("database,d",
      ...
      "direct-only,r", "print direct properties")("output,o",
      ...
      "output format (\"json\", \"xml\" or \"info\")")("help,h", "Print help message");
