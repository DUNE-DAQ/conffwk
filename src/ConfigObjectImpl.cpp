...
public:
  ...
  virtual bool rel(const std::string& /*association*/, std::vector<ConfigObject>& /*value*/)
  {
    bad();
    return false;
  }
  ...
  virtual void set(const std::string& /*association*/, const std::vector<const ConfigObject*>& /*value*/, bool)
  {
    bad();
  }
...
ConfigObjectImpl::ConfigObjectImpl(ConfigurationImpl* impl,
                                   const std::string& id,
                                   dunedaq::conffwk::ObjectState state) noexcept
  : m_impl(impl)
  , m_state(state)
  , m_id(id)
...
ConfigObjectImpl*
ConfigObjectImpl::default_impl() noexcept
{
