 ...
 *  \brief conffwk schema description
 */

#ifndef CONFFWK_SCHEMA_H_
#define CONFFWK_SCHEMA_H_
...
struct attribute_t
{
  ...
  std::string p_range; /*!< the attribute range in UML syntax (e.g.: "A,B,C..D,*..F,G..*" => value can be A, B, greater
                          or equal to C and less or equal to D, less or equal to F, greater or equal to G) */
  ...
  bool p_is_multi_value; /*!< if true, the value of attribute is a list of primitive values (e.g. list of strings, list
                            of integer numbers, etc.) */
  ...
  attribute_t(const std::string& name,
              type_t type,
  ...
  void print(std::ostream& out,             /*!< the output stream */
...
struct relationship_t
{
  ...
  bool p_is_aggregation;     /*!< if true, the relationship is an aggregation (composite); otherwise the relationship is
                                simple (weak) */
  std::string p_description; /*!< the description text of relationship */

  /** Create relationship description */

  relationship_t(const std::string& name,
...
std::ostream&
operator<<(std::ostream& out, const attribute_t&);
std::ostream&
operator<<(std::ostream& out, const relationship_t&);
std::ostream&
operator<<(std::ostream& out, const class_t&);

}
}

#endif // CONFFWK_SCHEMA_H_
