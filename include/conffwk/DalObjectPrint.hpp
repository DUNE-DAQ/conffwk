...
/**
 *  \file DalObjectPrint.h This file contains various print functions used to implement print() method in generated DAL
 * classes.
...
template<>
void inline p_val<uint8_t>(std::ostream& s, const uint8_t& data)
{
  s << static_cast<uint16_t>(data);
}

template<>
void inline p_val<int8_t>(std::ostream& s, const int8_t& data)
{
