...
#ifndef CONFFWK_SUBSCRIPTION__CRITERIA_H_
#define CONFFWK_SUBSCRIPTION__CRITERIA_H_
...
class ConfigurationSubscriptionCriteria {
  ...
  public:
    ...
    void add(const std::string& class_name, const std::string& object_id);
       ...
       *  To be used for an object of class generated by genconffwk.
       *
       *  \param object  reference to object
       */

    void add(const DalObject2g& object);
    ...
    void remove(const std::string& class_name);
       ...
       *  add(const std::string&, const std::string&) or add(const DalObject2g&) methods.
       *
       *  \param class_name  name of the class
       *  \param object_id   object identity
       */
    ...
    void remove(const DalObject2g& object);
