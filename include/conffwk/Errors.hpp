...
ERS_DECLARE_ISSUE_BASE_HPP(conffwk, Generic, conffwk::Exception, , , ((const char*)what))
...
ERS_DECLARE_ISSUE_BASE_HPP(conffwk, NotFound, conffwk::Exception, , , ((const char*)type)((const char*)data))
...
ERS_DECLARE_ISSUE_BASE_HPP(conffwk,
                           DeletedObject,
                           conffwk::Exception,
                           ,
                           ,
