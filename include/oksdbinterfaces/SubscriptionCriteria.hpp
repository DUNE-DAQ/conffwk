...
#ifndef OKSDB_INTERFACE_SUBSCRIPTION__CRITERIA_H_
#define OKSDB_INTERFACE_SUBSCRIPTION__CRITERIA_H_
...
class ConfigurationSubscriptionCriteria {
  ...
  public:
    ...
    void add(const std::string& class_name, const std::string& object_id);
       ...
       *  To be used for an object of class generated by genoksdbinterfaces.
       *
