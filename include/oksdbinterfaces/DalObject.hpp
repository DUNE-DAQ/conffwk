...
#ifndef OKSDB_INTERFACE_DAL_OBJECT_H_
#define OKSDB_INTERFACE_DAL_OBJECT_H_
 ...
 *  - unread() mark object as non-read to re-read values of attributes and relationships from oksdbinterfaces object
 *  - remove() mark object as deleted
 *  - was_removed() return state of object's removal
 *  - set() assign oksdbinterfaces object
 */
...
protected:
   ...
   *  The method checks state of object and throws exception if it was deleted.
   *
   *  \throw dunedaq::oksdbinterfaces::Exception in case of problems
   */
...
public:
   ...
   *  \param o the oksdbinterfaces object
   */
...
public:
  ...
  /**
   *  Print object details (method generated by genoksdbinterfaces)
   ...
   *  \throw oksdbinterfaces::Exception in case of problems (e.g. OKS schema / generated DAL mismatch)
   */
  ...
  /// print error text
  static void p_error(std::ostream& s, dunedaq::oksdbinterfaces::Exception& ex);
  ...
  std::ostream& print_object(std::ostream& s) const
    {
      ...
      else if(p_obj.m_impl->m_state != dunedaq::oksdbinterfaces::Valid)
        {
          DalObject::p_rm(s);
        }
      else
  ...
  /// throw object initialisation exception (i.e. \throw dunedaq::oksdbinterfaces::Generic)
  void throw_init_ex(dunedaq::oksdbinterfaces::Exception& ex);

  /// throw exception in generated get method (i.e. \throw dunedaq::oksdbinterfaces::Generic)
...
protected:
  ...
  /**
   *  Initialize object (method generated by genoksdbinterfaces)
        ...
        if (try_cast(&TARGET::s_class_name, obj->m_class_name) == true)
          {
            ...
            if (obj->m_state == dunedaq::oksdbinterfaces::Valid)
