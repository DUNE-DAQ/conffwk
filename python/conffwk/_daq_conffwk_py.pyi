...
class _Configuration:
    ...
    def create_db(self, db_name: str, includes: list[str]) -> None:
        ...
        """
    @typing.overload
    def create_obj(self, at: str, class_name: str, id: str) -> _ConfigObject:
        """
        Create new object by class name and object id.
        """
    @typing.overload
    def create_obj(self, at: _ConfigObject, class_name: str, id: str) -> _ConfigObject:
        """
        Create new object by class name and object id.
        """
    def destroy_obj(self, object: _ConfigObject) -> None:
        """
    ...
    def get_includes(self, db_name: str) -> list[str]:
        ...
        """
    def get_obj(self, class_name: str, id: str) -> _ConfigObject:
        """
        Create a configuration object containing the desired entity from the database
        """
    def get_objs(self, class_name: str, query: str = '') -> list[_ConfigObject]:
        """
