...
# Renamed since fork: yes (from python/tests/test_dal.py to scripts/test_dal.py).
...
class DalTest(unittest.TestCase):
    ...
    def test37_BookkeepUpdatedObjects(self):
        ...
        self.assertEqual(len(conffwk.updated_dals()), 0)
        obj.bool = False
        self.assertEqual(len(conffwk.updated_dals()), 1)
        self.assertEqual(conffwk.updated_dals(), set((obj,)))
        obj.sint8 = 0
        self.assertEqual(len(conffwk.updated_dals()), 1)
        ...
        obj1.bool = False
        self.assertEqual(len(conffwk.updated_dals()), 2)
        self.assertEqual(conffwk.updated_dals(), set((obj, obj1)))
